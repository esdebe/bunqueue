...
- **AWS Step Functions** uses JSON-based Amazon States Language, not real code
...
<Aside type="tip" title="40+ workflow tests">
The workflow engine ships with 40+ tests covering linear flows, branching, compensation, signals, timeouts, and concurrent execution — in both embedded and TCP modes.
</Aside>
