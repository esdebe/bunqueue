...
Measured on Apple M2 Pro, 16GB RAM. Run `bun run bench` for your hardware.

<CardGrid>
  <Card title="50-150K ops/sec" icon="rocket">
    Push throughput with batch operations
  </Card>
  <Card title="< 1ms p99" icon="seti:clock">
    Sub-millisecond latency
  </Card>
  <Card title="~50MB base" icon="document">
    Minimal memory footprint
  </Card>
  <Card title="< 100ms" icon="star">
    Cold start time
  </Card>
</CardGrid>
